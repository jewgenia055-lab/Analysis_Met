...
st.markdown("""***В проекте ИД синтетические, сгенерированы на основе нормального распределения с добавлением выбросов.***""")

st.markdown("""Исходными данными (ИД) для проведения анализа являются результаты испытаний образцов на разрывной машине.
...
st.markdown("""Образцы соответствуют требованиями **ГОСТ 1497-84**. Cсылка : """)
